  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className="absolute top-1/2 right-1/3 w-64 h-64 rounded-full bg-pink-500/10 blur-3xl animate-float"
      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subheading */}
          <p
            className="text-xl sm:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-slide-up"
            style={{ animationDelay: "0.1s" }}
          >
            Fix broken code, earn XP, and unlock programming concepts. Break
            free from tutorial hell with hands-on debugging quests.
          </p>
...
const FeaturePill: React.FC<{ icon: React.ReactNode; text: string }> = ({
  icon,
  text,
}) => (
